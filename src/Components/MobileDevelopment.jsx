...
>
    ...
    <div className="space-y-6">
      {[
        ...
        <div key={idx} className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
          <div className="flex-shrink-0 bg-white border border-gray-300 p-3  flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24">
        ...
        <section className='bg-[#F4F6FA] py-10'>
            <div className='px-16 md:px-20 md:ml-7 space-y-4'>
                <h1 className='font-kumbh  font-semibold text-xl sm:text-3xl md:text-4xl leading-[66px] '>🏢 Industries We Serve</h1>
                <p className='text-gray-600 md:ml-2'>Doelsoft has deep expertise in industry-specific mobile apps:</p>
            </div>
            <div className='grid grid-cols-1 md:ml-10 md:grid-cols-2 py-10 px-16 md:px-20 gap-6'>
  ...
  <div className="text-center md:text-left md:ml-6 px-4 sm:px-6 lg:px-20 mb-10">
  ...
  {/* Talent Cards */}
  <div className="container mx-auto  px-4 md:-ml-4 sm:px-6 lg:px-32 grid gap-6 sm:grid-cols-2 lg:grid-cols-2">
    {[
      ...
      >
        <img src={item.src} alt="" className="w-12 h-12 sm:w-16 sm:h-16 flex-shrink-0" />
  ...
  <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center md:items-start gap-10">
    ...
    <div className="flex-1 ">
      <h1 className="text-2xl sm:text-3xl md:text-4xl md:-ml-7 justify-start md:whitespace-nowrap font-kumbh font-semibold mb-8 leading-[57.20px]">
    ...
    {/* Right Image */}
    <div className="w-full mt-16 md:-mb-72">
      <img
        src="/youngmen.svg"
        alt="Man holding toy plane"
        className="w-auto h-auto md:w-[647px] md:h-[647px] "
      />
    </div>

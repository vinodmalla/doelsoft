...
>
  ...
  <div className="relative z-10 flex-1 flex flex-col  items-start justify-center space-y-6 text-center md:text-left">
      <h1 className="text-lg md:text-xl font-semibold text-gray-800">Talent Hub</h1>
                <h2 className="text-3xl md:text-5xl font-bold text-red-600 mt-2">Contract/<br />Temporary Hiring</h2>


    <button className="py-2 px-5 border border-black ml-[55px] md:ml-[9px]  text-black hover:bg-gray-200 transition-all duration-200">
  ...
  <div className="space-y-6 ml-0 sm:ml-6 md:ml-10 text-center md:text-left">
    ...
    <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-6">
      ...
      <div className="w-full md:w-1/2 space-y-4">
        <h2 className="text-xl sm:text-2xl font-bold">The DoelSoft Advantages</h2>
      ...
      <div className="w-full md:w-1/2 flex justify-center md:justify-end">
        <img
          src="/Image2.svg"
          alt="Contract"
          className="w-full sm:w-3/4 md:w-1/2 lg:w-3/4 h-auto object-contain md:object-cover md:h-96 ml-0 md:ml-10"
        />
      </div>
    </div>
  </div>
